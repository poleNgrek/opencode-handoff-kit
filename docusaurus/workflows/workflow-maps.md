---
title: Branch context workflow maps
sidebar_position: 3
---
...
When diagrams and commands diverge, update **[`documentation/WORKFLOW_MAPS.md`](../../documentation/WORKFLOW_MAPS.md)** in the **same PR** as the command change.
